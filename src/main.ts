...
import { findAssociatedTokenAddress, createAssociatedTokenAccount } from './utils'
...
export async function create(
  ...
  if (possibleSourceTokenPubkey == null) {
    possibleSourceTokenPubkey = await findAssociatedTokenAddress(sourceTokenOwner, mintAddress)
  }
  ...
  const vestingTokenAccountKey = await findAssociatedTokenAddress(vestingAccountKey, mintAddress)
